...
enum Constants {
    static let titleStart = "START"
    static let titleSettings = "SETTINGS"
    static let titleRecords = "RECORDS"
    static let firstScreenTitle = "Simple Racing"
    ...
    static let constraint20: CGFloat = 20.0
    static let constraintMinus20: CGFloat = -20.0
    static let constraint40: CGFloat = 40.0
    static let constraint30: CGFloat = 30.0
    static let constraint50: CGFloat = 50.0
    static let constraintMinus50: CGFloat = -50.0
    static let constraint60: CGFloat = 60.0
    static let constraint80: CGFloat = 80.0
    static let constraint100: CGFloat = 100.0
    static let constraint200: CGFloat = 200.0
    static let constraintMinus100: CGFloat = -100.0
